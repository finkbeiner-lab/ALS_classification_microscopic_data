...
class MaxViT(nn.Module):
    def __init__(self, args):
        ...
        # Classifier head
        self.global_pool = nn.AdaptiveAvgPool2d(1)  # ensures flexible input size
        self.classifier = nn.Linear(in_dim, args['num_classes'])
    ...
    def forward(self, x):
        ...
        logits = self.classifier(x)   # raw scores for CE loss
        return logits
