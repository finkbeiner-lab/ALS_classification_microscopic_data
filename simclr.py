...
#MODEL_CHECKPOINTS_FOLDER  =   "/gladstone/finkbeiner/steve/work/data/npsad_data/monika/Julia_TDP43/All_C9ORF72/"
...
#                                                                last_epoch=-1)
        ...
        #model_checkpoints_folder = os.path.join(MODEL_CHECKPOINTS_FOLDER, 'checkpoints')
